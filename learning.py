from game import pygamewithtf2
import numpy as np
import random
import csv
...
def train_net(model, params):
    ...
    game_state = pygamewithtf2.GameState()

    # Get initial state by doing nothing and getting the state.
    _, state = game_state.frame_steps((2))
    ...
    while t < train_frames:
        ...
        reward, new_state = game_state.frame_steps(action)
...
def log_results(filename, data_collect, loss_log):
    ...
    with open('learn_data-' + filename + '.csv', 'w') as data_dump:
